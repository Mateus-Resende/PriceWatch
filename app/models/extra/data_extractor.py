...
class DataExtractor():
    ...
    def parse(self):
        ...
        # sistema operacional
        #data['operation_system'] = self.response.findAll("", {"class": "Sistema-operacional"})
        #data['operation_system'] = self.normalize_operation_system(data['operation_system'])
        ...
        #data['color'] = self.normalize_color(data, 'color')
