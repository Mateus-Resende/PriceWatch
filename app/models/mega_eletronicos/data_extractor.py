...
class DataExtractor():
    ...
    def parse(self):
        ...
        try:
            # processador
            data['processor'] = r.find('td', text=re.compile(r'(Processor|Processador|Intel)')).parent.find('td', {'width': '65%'}).text
        ...
        # marca
        try:
            data['brand'] = r.find('div', {'class': 'col-md-12 col-sm-12'}).parent.find('h1').text
