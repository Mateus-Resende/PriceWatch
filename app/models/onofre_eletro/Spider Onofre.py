...
class SpiderOnofreEletro(scrapy.Spider):
  ...
  name = 'spider'
  start_urls = ['http://www.onofreagora.com.br/eletro/departamento/125972/0905/computador-notebook']
  download_delay = 1.5

  
  def parse(self, response):
    for vitrine in response.css('.itemGtm'):
      link_data = { 
        "nome": vitrine.css('a.text-default::text').extract_first(),
